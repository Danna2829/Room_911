...
| HU-003 | CU003 / Gestionar_usuarios | `POST /api/usuarios` | `usuario`, `perfil` | Implementada |
| HU-004 | CU004 / Gestionar_usuarios | `GET /api/usuarios/{id}` | `usuario`, `perfil` | Implementada |
| HU-005 | CU001, CU005 / Gestionar_permisos_accesos | `GET /api/perfiles`, `POST /api/usuarios` | `usuario`, `perfil`, `medicamento` | Implementada |
...
| HU-011 | CU001, CU002, CU003 / Gestionar_cronograma | `GET/POST/PUT/DELETE /api/cronogramas` | `cronograma`, `medicamento` | API/UI |
